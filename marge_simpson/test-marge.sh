...
echo "[1/5] File existence checks..."
...
echo "[2/5] Script syntax validation..."
...
echo "[3/5] Folder name auto-detection..."
...
echo "[4/5] verify.sh --skip-if-no-tests behavior..."
...
echo "[5/5] cleanup.sh preview mode..."
